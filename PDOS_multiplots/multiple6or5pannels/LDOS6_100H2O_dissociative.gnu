...
set output 'LDOS6_100H2O_dissociative.png'
...
# Set individual keys
 ...
 set label "L6" at -9.5,-2.2
  ...
  plot   "molecules/H2O_paw_12A_nspin2/O_states/O_p_tot_mole_H2O_shifted.dat"  using 1:2 title "Total DOS S in H2O molecule" with filledcurve y1=0 fs transparent solid 0.6 ls 2 , \
         ...
         "dissociative/Fe_100_2x2_HO_FH_O_SB_0.25ML_DOS/LA/O_states/O_tot_LA_shifted.dat" using 1:2 title "Total DOS O on adsor" with filledcurve y1=0 fs transparent pattern 5 ls 2, \
         "dissociative/Fe_100_2x2_HO_FH_O_SB_0.25ML_DOS/LA/O_states/O_tot_LA_shifted.dat" using 1:3 title "" with filledcurve y1=0 fs transparent pattern 5 ls 2, \
         ...
         "dissociative/Fe_100_2x2_HO_FH_O_SB_0.25ML_DOS/LA/H_tot_LA_shifted.dat"  using 1:2 title "Total DOS H on adsor" with filledcurve y1=0 fs transparent pattern 4 ls 3, \
         "dissociative/Fe_100_2x2_HO_FH_O_SB_0.25ML_DOS/LA/H_tot_LA_shifted.dat"  using 1:3 title "" with filledcurve y1=0 fs transparent pattern 4 ls 3, \
         "dissociative/Fe_100_2x2_HO_FH_O_SB_0.25ML_DOS/LA/H_tot_LA_shifted.dat"  using 1:2 title "Total DOS H on adsor" with lines ls 3, \
         "dissociative/Fe_100_2x2_HO_FH_O_SB_0.25ML_DOS/LA/H_tot_LA_shifted.dat"  using 1:3 title "" with lines ls 3;
