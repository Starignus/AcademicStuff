...
set output 'LDOS_100H2S_dissociative_2row.png'
...
#'***********************'
 ...
 set label "LA" at -9.5,-4
  ...
  plot   "molecules/H2S_paw_12A_nspin2/S_states/S_tot_mole_H2S_shifted.dat"  using 1:2 title "Total DOS S in H2S molecule" with filledcurve y1=0 fs transparent solid 1 ls 1 , \
         ...
         "dissociative/Fe_100_2x2_H2S_FH_DOS/LA/S_states/S_tot_LA_shifted.dat" using 1:2 title "Total DOS S on adsor" with filledcurve y1=0 fs transparent pattern 4 ls 1, \
         "dissociative/Fe_100_2x2_H2S_FH_DOS/LA/S_states/S_tot_LA_shifted.dat" using 1:3 title "" with filledcurve y1=0 fs transparent pattern 4 ls 1, \
         "dissociative/Fe_100_2x2_H2S_FH_DOS/LA/S_states/S_tot_LA_shifted.dat" using 1:2 title "Total DOS S on adsor" with line ls 1, \
         "dissociative/Fe_100_2x2_H2S_FH_DOS/LA/S_states/S_tot_LA_shifted.dat" using 1:3 title "" with lines ls 1, \
         "dissociative/Fe_100_2x2_H2S_FH_DOS/LA/H_s_tot_LA_shifted.dat"  using 1:2 title "Total DOS H on adsor" with filledcurve y1=0 fs transparent pattern 5 ls 3, \
         "dissociative/Fe_100_2x2_H2S_FH_DOS/LA/H_s_tot_LA_shifted.dat"  using 1:3 title "" with filledcurve y1=0 fs transparent pattern 5 ls 3, \
         "dissociative/Fe_100_2x2_H2S_FH_DOS/LA/H_s_tot_LA_shifted.dat"  using 1:2 title "Total DOS H on adsor" with lines ls 3, \
         "dissociative/Fe_100_2x2_H2S_FH_DOS/LA/H_s_tot_LA_shifted.dat"  using 1:3 title "" with lines ls 3;
